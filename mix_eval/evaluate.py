...
def parse_args():
    ...
    parser.add_argument("--batch_size_judge", type=int, default=1, help="Batch size for judge model.")
    parser.add_argument(
        "--max_gpu_memory",
        type=str,
        default=None,
...
def _eval(args):
    ...
    dataloader = DataLoader(
        eval_dataset, batch_size=args.batch_size, shuffle=False, num_workers=12, collate_fn=lambda x: x
    )
